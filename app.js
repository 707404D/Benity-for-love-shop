...
if (document.querySelector(".main__content").classList.contains("filter")) {
   ...
   for (i = 0; i < menubtns.length; i++) {
      menubtns[i].addEventListener("click", function () {
         ...
         // if (menubtnsContent.style.display === "flex") {
         //    menubtnsContent.style.display = "none";
         // } else {
         //    menubtnsContent.style.display = "flex";
         // }
         var menubtnsContent = this.nextElementSibling;
...
// Filter slider
if (document.querySelector(".main__content").classList.contains("filterslider")) {
   $(function () {
      $('#slider').slider({
         range: true,
         min: 0,
...
if (document.querySelector(".main__content").classList.contains("cards")) {
   // var mainitems = document.getElementsByClassName("main__item");
   // for (i = 0; i < mainitems.length; i++) {
   //    mainitems[i].addEventListener("click", function (e) {
   //       e.preventDefault();
   ...
   var currentsizeItem = document.getElementsByClassName("main__item-sizes-size");
